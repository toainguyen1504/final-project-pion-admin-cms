...
import { fetchLesson, updateLesson } from "@/lib/api/learning/lessons";
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      if (lesson) {
        ...
        setIsQuiz(lesson.is_quiz || false);
      }
    };
    loadData();
    ...
    <div className="px-4 py-6 max-w-2xl space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-slate-600 dark:text-slate-400">
          Cập nhật thông tin cho bài học thuộc khóa học{" "}
      ...
      >
        ...
        >
          {loading ? "Đang xử lý..." : "Cập nhật Bài Học"}
        </Button>
      </form>
    </div>
  );
