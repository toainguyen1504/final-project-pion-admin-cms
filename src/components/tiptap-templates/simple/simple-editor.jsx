...
// custom node
import { ImageLibraryNode } from "@/components/tiptap-node/image-library-node/image-library-node-extension";
...
export function SimpleEditor({ onReady }) {
  ...
  const editor = useEditor({
    ...
    extensions: [
      ...
      // Image,
      ImageLibraryNode, // ⚡ Dùng custom node
      Typography,
      Superscript,
      Subscript,
      Selection,
